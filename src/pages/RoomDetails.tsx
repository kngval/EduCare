        ...
        <div className="grow">
          ...
          <div className="grid gap-5">
            {students && students.length > 0 && students.map((student) => (
              <div className={`grid ${role == "student" ? "grid-cols-1" : "grid-cols-12"}`}>
                <div key={student.id} onClick={() => viewProfile(student)} className={`${role == "student" ? "rounded-md" : "rounded-l-md"} col-span-11 bg-customBlue2  py-3 px-6 grid grid-cols-4 items-center text-xs hover:bg-customLightBlue ease-in-out duration-500`}>
                ...
                <div onClick={() => gradeStudent(student)} className={`${role == "student" ? "hidden" : "block"} bg-customBlue2 rounded-r-md flex justify-center items-center cursor-pointer`}>
